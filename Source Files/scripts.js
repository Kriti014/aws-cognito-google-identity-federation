...
function credentialExchange(googleToken) {
  ...
  if (googleTokenDecoded['sub']) {
    ...
    AWS.config.credentials = new AWS.CognitoIdentityCredentials({
      IdentityPoolId: 'us-east-1:3004a901-09ba-41b2-a7c3-9e486ae15096', // MAKE SURE YOU REPLACE THIS
      Logins: {
...
function accessImages() {
  ...
  var s3 = new AWS.S3();
  var params = {
    Bucket: "webidf-patchesprivatebucket-c4njqlgnmzck" // MAKE SURE YOU REPLACE THIS
  }; 
